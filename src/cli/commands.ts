...
import { promptForListTodos, promptForUpdateTodo, promptForAddTodo, promptForRemoveTodo } from "./prompts.js"
...
export const removeCommand = Command.make("remove", {}, () => promptForRemoveTodo().pipe(
  Effect.provide(TodoRepositoryLayer),
  Effect.catchAll((error) =>
    Console.log(`Error: ${error.message}`)
  )
